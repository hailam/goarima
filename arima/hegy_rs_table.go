// Code generated from uroot 2.1.3's hegy.rs.pvalue (the rq quantile axis
// is hardcoded inside that R function, not stored in tabs); do not edit.
//
// rq <- c(c(1e-04, 2e-04, 5e-04, seq_len(10)/1000),
//         seq.int(15, 985, 5)/1000,
//         1 - rev(c(1e-04, 2e-04, 5e-04, seq_len(10)/1000)))
//
// 221 quantile levels, used by every response-surface table in
// hegy_rs_tables.go.

package arima

var hegyRSQuantiles = [221]float64{
	0.0001, 0.0002, 0.0005, 0.001, 0.002, 0.003, 0.004, 0.005,
	0.006, 0.007, 0.008, 0.009, 0.01, 0.015, 0.02, 0.025,
	...
	0.35, 0.355, 0.36, 0.365, 0.37, 0.375, 0.38, 0.385,
	0.39, 0.395, 0.4, 0.405, 0.41, 0.415, 0.42, 0.425,
	0.43, 0.435, 0.44, 0.445, 0.45, 0.455, 0.46, 0.465,
	0.47, 0.475, 0.48, 0.485, 0.49, 0.495, 0.5, 0.505,
	0.51, 0.515, 0.52, 0.525, 0.53, 0.535, 0.54, 0.545,
	0.55, 0.555, 0.56, 0.565, 0.57, 0.575, 0.58, 0.585,
	0.59, 0.595, 0.6, 0.605, 0.61, 0.615, 0.62, 0.625,
	0.63, 0.635, 0.64, 0.645, 0.65, 0.655, 0.66, 0.665,
	0.67, 0.675, 0.68, 0.685, 0.69, 0.695, 0.7, 0.705,
	0.71, 0.715, 0.72, 0.725, 0.73, 0.735, 0.74, 0.745,
	...
	0.998, 0.999, 0.9995, 0.9998, 0.9999,
}
