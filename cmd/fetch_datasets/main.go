...
//
//	go run ./cmd/fetch_datasets ausbeer    # populate ausbeer_r.go
//	go run ./cmd/fetch_datasets gasoline   # populate gasoline_r.go
//	go run ./cmd/fetch_datasets all        # both
//
...
func writeGenerated(path, varName, descr, attrib, url string, values []float64) error {
	...
	fmt.Fprintf(&sb, "// Code generated by cmd/fetch_datasets. DO NOT EDIT.\n")
	fmt.Fprintf(&sb, "//\n")
	fmt.Fprintf(&sb, "// %s\n", descr)
	fmt.Fprintf(&sb, "// %s\n", attrib)
